  ...
  return (
    <div className={styles["card-flip"]}>
      <div className={styles["content-flip"]}>
        ...
        {/* Cara frontal */}
        <div className={bg}>
          <h3 className='mb-2 text-center text-xl font-sans font-semibold tracking-tight text-white'>{title}</h3>
        ...
        {/* Cara trasera */}
        <div className={bg}>
          <h3 className='mb-2 text-center text-xl font-sans font-semibold tracking-tight text-white'>{backTitle}</h3>

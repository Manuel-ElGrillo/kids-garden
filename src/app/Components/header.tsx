  ...
  return (
    <header className="flex h-60 mt-[-30px] bg-white">
      ...
      <section className="flex justify-around w-8/12 p-10">
        ...
        {/* Login, registro y DarkMode */}
        <div className="flex place-self-start space-x-8 text-lg">
          <div>
            <Tooltip
              className="flex items-center h-20 w-52 text-center"
              content="Esta seccion es solo para alumnos registrados"
              placement="bottom"
              arrow={false}
            >
              <Ingresar />
          ...
          <div className="flex gap-2 duration-100 dark:bg-slate-800 bg-gray-100 rounded">
            <Tooltip content='Switch to "DARK MODE"' placement="bottom">
              <DarkThemeToggle />
            </Tooltip>
          </div>
        </div>
